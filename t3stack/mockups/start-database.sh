...
DB_CONTAINER_NAME="mockups-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=mockups -d -p 5432:5432 docker.io/postgres
